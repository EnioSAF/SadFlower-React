    ...
    return (
        <div className="edit-avatar-container">
            <PixelArtCard size={100} color={avatar.baseColor} hoverColor={avatar.hoverColor}>
                ...
                <PixelArtCard.EyesAccessory value={avatar.eyesAccessory} color={avatar.eyesAccessoryColor} />
                <PixelArtCard.EarAccessory value={avatar.earAccessory} color={avatar.earAccessoryColor} />
                ...
                <PixelArtCard.MouthAccessory value={avatar.mouthAccessory} color={avatar.mouthAccessoryColor} />
            ...
            <div>
                ...
                <div>
                    ...
                    <input type="color" value={avatar.hairColor} onChange={(e) => updateAvatarColor('hair', e.target.value)} />
                </div>
                <div>
                    <label>Accessoire de tête:</label>
                    <select onChange={(e) => updateAvatarPart('headAccessory', e.target.value)} value={avatar.headAccessory}>
                        {headAccessoryTypes.map(type => <option key={type} value={type}>{type}</option>)}
                    </select>
                    <input type="color" value={avatar.headAccessoryColor} onChange={(e) => updateAvatarColor('headAccessory', e.target.value)} />
                </div>
                <div>
                    <label>Yeux:</label>
                    <select onChange={(e) => updateAvatarPart('eyes', e.target.value)} value={avatar.eyes}>
                        {eyeTypes.map(type => <option key={type} value={type}>{type}</option>)}
                    </select>
                    <input type="color" value={avatar.eyesColor} onChange={(e) => updateAvatarColor('eyes', e.target.value)} />
                </div>
                <div>
                    <label>Accessoire pour les yeux:</label>
                    <select onChange={(e) => updateAvatarPart('eyesAccessory', e.target.value)} value={avatar.eyesAccessory}>
                        {eyesAccessoryTypes.map(type => <option key={type} value={type}>{type}</option>)}
                    </select>
                ...
                <div>
                    ...
                    <input type="color" value={avatar.earAccessoryColor} onChange={(e) => updateAvatarColor('earAccessory', e.target.value)} />
                </div>
                <div>
                    <label>Nez:</label>
                    <select onChange={(e) => updateAvatarPart('nose', e.target.value)} value={avatar.nose}>
                        {noseTypes.map(type => <option key={type} value={type}>{type}</option>)}
                    </select>
                </div>
                <div>
                    <label>Barbe:</label>
                    <select onChange={(e) => updateAvatarPart('beard', e.target.value)} value={avatar.beard}>
                        {beardTypes.map(type => <option key={type} value={type}>{type}</option>)}
                    </select>
                </div>
                <div>
                    <label>Bouche:</label>
                    <select onChange={(e) => updateAvatarPart('mouth', e.target.value)} value={avatar.mouth}>
                        {mouthTypes.map(type => <option key={type} value={type}>{type}</option>)}
                    </select>
                    <input type="color" value={avatar.mouthColor} onChange={(e) => updateAvatarColor('mouth', e.target.value)} />
                </div>
                <div>
                    <label>Accessoire de bouche:</label>
                    <select onChange={(e) => updateAvatarPart('mouthAccessory', e.target.value)} value={avatar.mouthAccessory}>
                        {mouthAccessoryTypes.map(type => <option key={type} value={type}>{type}</option>)}
                    </select>
                    <input type="color" value={avatar.mouthAccessoryColor} onChange={(e) => updateAvatarColor('mouthAccessory', e.target.value)} />
                </div>
                <div>
                    <label>Accessoire de cou:</label>
                    <select onChange={(e) => updateAvatarPart('neckAccessory', e.target.value)} value={avatar.neckAccessory}>
                        {neckAccessoryTypes.map(type => <option key={type} value={type}>{type}</option>)}
                    </select>
                    <input type="color" value={avatar.neckAccessoryColor} onChange={(e) => updateAvatarColor('neckAccessory', e.target.value)} />
                </div>
            </div>
