...
const TimeLineEnio = (props) => {
  return (
    <VerticalTimeline lineColor={"#ffffffff"}>
      <VerticalTimelineElement
        ...
        <h3 className='vertical-timeline-element-title'>
          {`
    Formation "Concepteur Développeur d'Applications" (bac +3/4)
    `}
        </h3>
    ...
    `}
        ...
        <p>{`• Installer et configurer son environnement de travail en fonction du projet • Analyser les besoins et maquetter une application`}</p>
        <p>{`• Développer des interfaces utilisateur`}</p>
        <p>{`• Web statique`}</p>
        <p>{`• Javascript`}</p>
        <p>{`• Concevoir et mettre en place une base de données relationnelle et développer des composants  d’accès aux données SQL et NoSQL`}</p>
        <p>{`• Base de données, Merise`}</p>
        <p>{`• Langages SQL et noSQL`}</p>
        <p>{`• Définir l’architecture logicielle d’une application`}</p>
        <p>{`• Architecture logicielle, UML`}</p>
        <p>{`• Ecoconception`}</p>
        <p>{`• Développer des composants métier`}</p>
        <p>{`• Java SE, API REST, Hibernate`}</p>
        <p>{`• Maven`}</p>
        <p>{`• Projet « Business case » en mode fil rouge`}</p>
        <p>{`ALTERNANCE CCP 1 • DÉVELOPPER UNE APPLICATION SÉCURISÉE`}</p>
        <p>{`• Développer des interfaces utilisateur`}</p>
        <p>{`• Thymeleaf`}</p>
        <p>{`• Angular`}</p>
        <p>{`• Développer des composants métier`}</p>
        <p>{`• Rappels du bootcamp : JAVA`}</p>
        <p>{`• Spring`}</p>
        <p>{`• Contribuer à la gestion d’un projet informatique`}</p>
        <p>{`• Gestion de projet, Scrum (certification Scrum Master PSM 1)`}</p>
        <p>{`ALTERNANCE CCP 2 • CONCEVOIR ET DÉVELOPPER UNE APPLICATION SÉCURISÉE ET ORGANISÉE  EN COUCHES`}</p>
        <p>{`• Définir l’architecture logicielle d’une application`}</p>
        <p>{`• Sécurité des SI`}</p>
        <p>{`• Développer des composants d’accès aux données SQL et NoSQL`}</p>
        <p>{`• Rappels du bootcamp : base de données et requêtages`}</p>
        <p>{`ALTERNANCE CCP 3 • PRÉPARER LE DÉPLOIEMENT D’UNE APPLICATION SÉCURISÉE`}</p>
